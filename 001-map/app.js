...
//Sukurti masyva penkiu elementu, kuriuose butu random skaiciai nuo...iki
...
//padidinti cats svori +1
const cats2 = cats.map(c => ({ ...c, weight: c.weight + 1 }));
console.log(cats2);

//katinukai random svorio nuo 3 iki 10
const cats3 = cats.map(c => ({ ...c, weight: rand(3, 10) }));
console.log(cats3);

//pridedi po papildomą savybę takesPill kuri atsitiktiniu būdu yra arba 'yes' arba 'no'
